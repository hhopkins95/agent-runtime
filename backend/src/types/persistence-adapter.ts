...
import { RuntimeSessionData, SavedSessionData, SessionListData, WorkspaceFile } from "./session";
...
export interface PersistenceAdapter {
   ...
   * Does not include the message history, but includes the raw transcript. The AgentSession class will handle parsing the transcript into the message history
   * 
   ...
   *
   * @param session - Session data without _id and _creationTime (generated by backend)
